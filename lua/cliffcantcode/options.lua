...
vim.opt.completeopt = { "menuone", "noselect", "noinsert"} 	-- mostly for cmp
...
vim.opt.shortmess = vim.opt.shortmess + { c = true }        -- hide all the completion messages, e.g. "-- XXX completion (YYY)", "match 1 of 2", "the only match", "Pattern not found"
